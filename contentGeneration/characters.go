...
func addPlayer(ecsManager *ecs.EntityManager, m *ecs.Manager, x, y int) {
...
func addMonster(ecsManager *ecs.EntityManager, x, y int) {
...
func addTownsMember(ecsManager *ecs.EntityManager, x, y int) {
